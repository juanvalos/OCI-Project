...
echo.
set SPRING_DATASOURCE_URL=jdbc:oracle:thin:@(description=(retry_count=20)(retry_delay=3)(address=(protocol=tcps)(port=1522)(host=adb.mx-queretaro-1.oraclecloud.com))(connect_data=(service_name=g6ce88b59fcfcca_e716dqdpxgbpxupn_high.adb.oraclecloud.com))(security=(ssl_server_dn_match=yes)))?TNS_ADMIN=C:/Users/juana/OneDrive/Escritorio/Wallet_E716DQDPXGBPXUPN
