...
public enum BotMessages {
    ...
    ENTER_TASK_DETAILS("Please enter the task details in the next format -> Task: [Name], [Description], [Difficulty (Alta/Media/Baja)], [Priority (Alta/Media/Baja)], [State (Sin empezar/En proceso/Terminada)], [Horas estimadas], [Horas reales (o 0)], [Fecha límite (YYYY-MM-DD)]."),
